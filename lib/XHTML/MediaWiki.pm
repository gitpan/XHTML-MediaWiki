...
other, more complicated markup languages with this module.

The most important method is C<XHTML::Mediawiki::format()>.

It should be noted that this module is written as a replacement for
L<XHTML::MediawikiFormat> that expands on that modules functionality.
...
#use XHTML::MediawikiFormat::Blocks;
use URI;
use URI::Escape;
...
{
    package Block::Ordered;
    use base "Block::Nested";
    sub start_block { "<ol>\n" }
    sub end_block { "</ol>\n" }
}
{
    package Block::Unordered;
    use base "Block::Nested";
    sub start_block { "<ul>\n" }
    sub end_block { "</ul>\n" }
}
